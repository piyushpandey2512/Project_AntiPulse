...
//     std::ifstream inFile("../build/PionInteractions_20250827_143922.dat");
//     if (!inFile) {
...
//     // --- ROOT file setup ---
//     TFile* outFile = new TFile("ExtrapolatedVertices_Corrected_new.root", "RECREATE");
...
int main() {
    ...
    SourceBox rightBox  = {stlPosition + TVector3(0, 0, 50 * cm),  reconBoxHalfX, reconBoxHalfY, boxHalfZ};
    SourceBox leftBox   = {stlPosition + TVector3(0, 0, -50 * cm), reconBoxHalfX, reconBoxHalfY, boxHalfZ};
    
    TFile* outFile = new TFile("ExtrapolatedVertices_Final_CorrectedMath.root", "RECREATE");
    TTree* tree = new TTree("ExtrapolatedVertexTree", "3D Extrapolated Track Origins");
    long long eventID; int trackID; double vx, vy, vz;
